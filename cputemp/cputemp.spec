...
# Unused heavy packages to exclude (not needed by this tiny widget)
_EXCLUDES = [
    # Numeric / ML / vision - massive and not used
    ...
    'tkinter', '_tkinter',
    'wx',
    # Qt submodules this app does NOT use
...
# Large DLLs that this lightweight widget does NOT need
_EXCLUDE_DLLS = {
...
# Drop all Qt translation files (saves ~3MB)
